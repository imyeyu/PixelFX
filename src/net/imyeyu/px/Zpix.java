...
public class Zpix {
	...
	private static Font buildS() {
		s = Font.loadFont(Zpix.class.getResourceAsStream(PixelFX.RES_PATH + "zpix.ttf"), S);
		return s;
	}
	
	private static Font buildM() {
		m = Font.loadFont(Zpix.class.getResourceAsStream(PixelFX.RES_PATH + "zpix.ttf"), M);
		return m;
	}
	
	private static Font buildL() {
		l = Font.loadFont(Zpix.class.getResourceAsStream(PixelFX.RES_PATH + "zpix.ttf"), L);
		return l;
	}
}
